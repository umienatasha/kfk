			...
			<div class="col-lg-12">
					<form action="regpro.php" method="post">
						...
						<div class="form-group">
							...
							<input type="number" name="ic" class="form-control" placeholder="Masukkan Kad Pengenalan" required />
						</div>
						...
						<div class="form-group">
							<label><strong>Pengesahan Kata Laluan</strong></label>
							<input type="password" name="password" class="form-control" placeholder="Masukkan Pengesahan Kata Laluan" required />
						</div>
