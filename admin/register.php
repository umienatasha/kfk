...
if (!$conn)
{
    ...
    if (isset($_REQUEST['username'])) {
        ...
        $query    = "INSERT into `tblpatient` (username, password, email, phone, address, gender, create_datetime)
                     VALUES ('$username', '" . md5($password) . "', '$email', '$phone', '$address', '$gender', '$create_datetime')";
		...
		<div class="container">
			...
			<div class="col-lg-12">
					<form action="" method="post">
						...
						<div class="form-group">
							<label><strong>Numebr Phone</strong></label>
