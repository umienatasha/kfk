				...
				<div class="card-header">
					<div class="row">
						...
						<div class="col-md-6 text-right">
							...
							<a href="editbooking.php?id=<?php echo $row["id_book"]; ?>" class="btn btn-secondary btn-sm" onClick="return confirm('Do you really want to update?');">Edit</a>
							<a href="viewbooking.php" class="btn btn-secondary btn-sm">Back</a>
