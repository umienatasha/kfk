					...
					<body>
						...
						<tr>
							...
							<td>
								...
								<center>												
								<button><a href="deleterawatan.php?id=<?php echo $row["id"]; ?>" class="btn btn-danger delete-listview-btn" onClick="return confirm('Do you really want to delete?');">Delete</a></button>
