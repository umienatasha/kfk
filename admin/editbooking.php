				...
				<div class="card-header">
					<div class="row">
						...
						<div class="col-md-6 text-right">
							<a href="displaybooking.php?id=<?php echo $row["id_book"]; ?>" class="btn btn-secondary btn-sm">View</a>
						</div>
					</div>
				</div>
				<div class="card-body">
					<form method="post" action="updatebooking.php">
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="date" name="date" class="form-control" value="<?php echo $row["date"];?>" required  data-parsley-trigger="keyup" />
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
						...
						<div class="form-group">
							<label><strong>Problem Patient</strong><span class="text-danger">*</span></label>
							<input type="text" name="comment" class="form-control" value="<?php echo $row["comment"];?>" required data-parsley-trigger="keyup"></textarea>
						</div>
