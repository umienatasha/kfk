...
if(isset($_POST['save']))
{
    ...
    {
        $search = $_POST['search'];
        $stmt = $conn->prepare("select * from bookings where  ic like '%$search%'");
        $stmt->execute();
...
<html lang="en">
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     ...
     <!-- Site Metas -->
    <title>Semakkan Temujanji</title>  
...
<body class="host_version"> 
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbars-host">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item active"><a class="nav-link" href="search.php">Semak Temujanji</a></li>
					</ul>
				</div>
			</div>
		</nav>
	...
	<div class="all-title-box">
		<div class="container text-center">
			<h1>Semak Temujanji<span class="m_1"></span></h1>
		</div>
	</div>
	...
	<form action="#" method="post" class="checkdomain form-inline" >
		<div class="checkdomain-wrapper">
			<div class="form-group">
				<label class="sr-only" for="email">Semakkan Temujanji</label>
				<input type="text" class="form-control" name="search" placeholder="Kad Pengenalan" required /><br>
				<button type="submit" name="save" value="Filter" class="btn btn-primary grd1"><i class="fa fa-search"></i></button>
			</div>
			<hr>
